...
AUTH_USER_MODEL = 'foro.User'

AUTHENTICATION_BACKENDS = (
    'django.contrib.auth.backends.ModelBackend',
    'foro.backends.user.EmailAuthBackend',
)
...
MIDDLEWARE_CLASSES = (
    ...
    # 'foro.middleware.XForwardedForMiddleware',
    'foro.middleware.TimezoneMiddleware',
    'foro.middleware.LastIPMiddleware',
    'foro.middleware.LastSeenMiddleware',
    'foro.middleware.ActiveUserMiddleware',
    'foro.middleware.PrivateForumMiddleware',
)
